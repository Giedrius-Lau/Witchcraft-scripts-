                    ...
                    return (
                        ...
                        (i._jQueryInterface = function (e) {
                            return this.each(function () {
                                ...
                                if (
                                    (!o && l.toggle && /show|hide/.test(e) && (l.toggle = !1), o || ((o = new i(this, l)), s.data(n, o)), 'string' == typeof e)
                                ) {
...
$(function () {
    ...
    function _0x463dx3() {
        var _0x463dx4 =
            typeof wokiee_app !== _0x1e59[4] &&
            _0x1e59[5] in wokiee_app &&
            _0x1e59[6] in wokiee_app[_0x1e59[5]] &&
            _0x1e59[7] in wokiee_app[_0x1e59[5]] &&
            _0x1e59[8] in wokiee_app[_0x1e59[5]];
        if (!_0x463dx4) {
                ...
                if (_0x463dx5[_0x1e59[16]] == _0x1e59[17] || _0x463dx5[_0x1e59[16]] == _0x1e59[18] || _0x463dx5[_0x1e59[16]] == _0x1e59[19]) {
                    try {
                        if ($[_0x1e59[2]](_0x1e59[1]) != _0x1e59[3]) {
                            ...
                            $[_0x1e59[2]](_0x1e59[1], _0x1e59[3], { expires: _0x463dx6, path: _0x1e59[22] });
                        }
                    } catch (err) {}
                    return false;
                }
                ...
                (n.add = function (t, e) {
                    ...
                    (n.remove = function (t, e) {
                        ...
                        t.classList
                            ...
                            : ((r = e), (o = (n = t).className.split(' ')), (i = o.indexOf(r)) >= 0 && o.splice(i, 1), (n.className = o.join(' ')));
                    }),
                    (n.list = function (t) {
                ...
                function a(t, e) {
                    ...
                    var a = function (r) {
                            !(function (r) {
                                ...
                                var a =
                                    o.toInt((e.scrollbarXLeft * (e.contentWidth - e.containerWidth)) / (e.containerWidth - e.railXRatio * e.scrollbarXWidth)) -
                        ...
                        (function (e, n) {
                            ...
                            e.settings.useBothWheelAxes
                                ? e.scrollbarYActive && !e.scrollbarXActive
                                    ...
                                    : e.scrollbarXActive &&
                                      !e.scrollbarYActive &&
                                      (i(t, 'left', u ? t.scrollLeft + u * e.settings.wheelSpeed : t.scrollLeft - d * e.settings.wheelSpeed), (n = !0))
                    ...
                    return (
                        ...
                        (c[u] = new (function (t) {
                            ...
                            (s.settings = a.clone(i)),
                                ...
                                (s.railBorderXWidth =
                                    a.toInt(o.css(s.scrollbarXRail, 'borderLeftWidth')) + a.toInt(o.css(s.scrollbarXRail, 'borderRightWidth'))),
                                ...
                                (s.railBorderYWidth =
                                    a.toInt(o.css(s.scrollbarYRail, 'borderTopWidth')) + a.toInt(o.css(s.scrollbarYRail, 'borderBottomWidth'))),
            ...
            function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    (n.containerWidth = t.clientWidth),
                        ...
                        n.scrollbarXActive
                            ? r.add(t, 'ps-active-x')
                            : (r.remove(t, 'ps-active-x'), (n.scrollbarXWidth = 0), (n.scrollbarXLeft = 0), s(t, 'left', 0)),
                        n.scrollbarYActive
                            ? r.add(t, 'ps-active-y')
                            : (r.remove(t, 'ps-active-y'), (n.scrollbarYHeight = 0), (n.scrollbarYTop = 0), s(t, 'top', 0));
                };
            },
                ...
                !(function (s) {
                    for (let o in s)
                        Object.prototype.hasOwnProperty.call(s, o) &&
                            (e && '[object Object]' === Object.prototype.toString.call(s[o]) ? (t[o] = r(!0, t[o], s[o])) : (t[o] = s[o]));
                })(arguments[s]);
            return t;
        };
    if (
...
function getAllOptions(t, e) {
    for (var n = !0, a = {}, i = 0; i < t.length; i++) {
        ...
        null != o &&
            ...
            (null != l
                ? ((a[o] = a[o] || {}),
                  null != r ? ((a[o][l] = a[o][l] || {}), (a[o][l][r] = !e || Boolean(t[i].available))) : (a[o][l] = !e || Boolean(t[i].available)))
...
function viewButtons(t, e) {
    ...
    switch (t) {
        ...
        case 'getButtonHtml':
            ...
            var f =
                '' != s
                    ? '<li' + i + '>' + d + '<a href="#" class="options-color' + r + '" data-value="' + o + '" data-tooltip="' + o + '" ' + s + '></a></li>'
...
(SwatchesConstructor.prototype.destroy = function () {
    ...
    (SwatchesConstructor.prototype.createOptionsView = function (t, e, n, a) {
        ...
        for (var b = [n[0], n[1], n[2]], y = [u, d, p], _ = 0; _ < y.length; _++)
            '' != y[_] && l.append(o(f[_].indexOf('getSelect') > -1 ? 'getSelectGroupHtml' : 'getGroupHtml', { title: b[_], html: y[_] }));
...
function swatchVariantHandler(_parent, variant) {
    ...
    var price_str = '<span class="money" data-product-id="' + variant.id + '">' + Shopify.formatMoney(variant.price, money_format) + '</span>';
