...
//         var secondAccordion = document.querySelector('div.accordion.accordion-name');
//         var addressFields = document.querySelector('#address_search_fill');
//         searchField.append(addressFields);

//         //User fields append to second accordion
//         if (document.querySelector('#address_search_fill > div:nth-child(3)') && document.querySelector('#address_search_fill > div:nth-child(3)')) {
//             secondAccordion.append(document.querySelector('#address_search_fill > div:nth-child(3)'));
//             secondAccordion.append(document.querySelector('#address_search_fill > div:nth-child(4)'));
//         }
...
//         var checkIcon = document.querySelector('.accordion-name');
//         if (!checkIcon.classList.contains('active')) {
//             checkIcon.classList.add('active');
//         }
//     };

//     document.querySelector('#address_search_sugest').addEventListener('click', function () {
//         movePanelToFirstAccordion();
//     });

//     var cityInputValue = document.querySelector('#shipping-city');
//     var addressInputValue = document.querySelector('#shipping-address');
//     var postcodeInputValue = document.querySelector('#shipping-postcode');
...
//     if ((cityInputValue && cityInputValue.value) || (addressInputValue && addressInputValue.value) || (postcodeInputValue && postcodeInputValue.value)) {
//         movePanelToFirstAccordion();
//     }
// }, 500);
