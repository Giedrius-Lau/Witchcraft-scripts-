...
selectedBox.innerHTML =
    "<label for>Dydis</label><strong class='value' data-value=''>" + itemInfoText + "</strong>";
...
// selectedBox.innerHTML = "<label for>Dydis</label><strong class='value' data-value=''>"+extractedInfoNumber+" <span class='upper-case'>"+extractedInfoText+"</span></strong>"
